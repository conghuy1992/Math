...
public class GameActivity extends Activity {
    ...
    private AdView mAdView, adView_2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adView_2 = (AdView) findViewById(R.id.adView_2);
        AdRequest adRequest_2 = new AdRequest.Builder().build();
        adView_2.loadAd(adRequest_2);
    }
    ...
    protected void onResume() {
        ...
        if (adView_2 != null) adView_2.resume();
    }
    ...
    protected void onPause() {
        ...
        if (adView_2 != null) adView_2.pause();
    }
    ...
    protected void onDestroy() {
        ...
        if (adView_2 != null) adView_2.destroy();
    }
    ...
    private Runnable mUpdateTimeTask = new Runnable() {
        public void run() {
            ...
            if (seconds < 10) {
                if (secondsb > seconds) {
                    mTimeLabel.setText("" + minutes + ":0" + secondsb);
                } else {
    ...
    public void processIntegerInput(View view) {
        if (acceptInput == true) {
            ...
            if (CURRENTMODE.toLowerCase() == PLUS) {
                myCurrentSum = myCurrentSum + bttnValueInt;
            } else if (CURRENTMODE.toLowerCase() == MINUS) {
                myCurrentSum = myCurrentSum - bttnValueInt;
            } else if (CURRENTMODE.toLowerCase() == MULTI) {
                myCurrentSum = myCurrentSum * bttnValueInt;
            } else if (CURRENTMODE.toLowerCase() == DIVIDE) {
                myCurrentSum = myCurrentSum / bttnValueInt;
            }
            currentNumber.setText(String.valueOf(myCurrentSum));
